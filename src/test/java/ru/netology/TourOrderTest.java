...
public class TourOrderTest {
    ...
    @Test
    @DisplayName("Оплата активной картой")
    ...
    @Test
    @DisplayName("Оплата неактивной картой")
    ...
    @Test
    @DisplayName("Оплата в кредит. Активная карта")
    ...
    @Test
    @DisplayName("Оплата в кредит. Неактивная карта")

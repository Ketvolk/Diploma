# План автоматизации тестирования окупки тура
------
...
### 1.4. Заполнение формы покупкм тура валидиными данными - отклонено банком
...
### 1.5. Заполнение формы покупки тура невалидными данными
*Предусловие:*
Вариант 1: Нажата кнопка "Купить"
Вариант 2: Нажата кнопка "Купить в кредит"
